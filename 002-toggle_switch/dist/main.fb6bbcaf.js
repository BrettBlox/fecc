...
toggle.removeAttribute('hidden'); // What we’re doing here is listening to our checkbox’s change event. We access the checkbox with event.target which returns the element that this event has happened on.
...
toggle.querySelector('input').addEventListener('change', function (evt) {

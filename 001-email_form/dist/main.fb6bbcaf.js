...
var renderAlert = function renderAlert() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'error';
  var iconPaths = {
  ...
  return "\n    <figure class=\"alert\" data-state=\"".concat(state, "\">\n      <svg class=\"alert__icon\" xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" focusable=\"false\" width=\"1em\" height=\"1em\" viewBox=\"0 0 24 24\">\n        <path fill=\"currentColor\" d=\"").concat(iconPaths[state], "\"/>\n      </svg>\n      <p class=\"alert__content\">").concat(messages[state], "</p>\n    </figure>\n    ");
};
/**
...
var init = function init() {
  ...
  var formElement = document.querySelector('#signupForm');
  var alertElement = document.querySelector('[role="alert"]');
  var validationRegex = new RegExp(emailElement.getAttribute('pattern') || '[^@]+@[^.]+..+', 'i');
